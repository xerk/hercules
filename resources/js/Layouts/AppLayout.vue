        ...
        <nav class="bg-white border-b border-gray-100">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('dashboard')">
								...
								/> -->
                                <svg fill="#315DA8" width="148" height="24" viewBox="0 0 164 24"
                                    ...
                                    <g id="Group_7" data-name="Group 7" transform="translate(-473 -375)">
                                        ...
                                        <g id="Group_6" data-name="Group 6" transform="translate(490.478 379)">
                    ...
                    <div class="hidden sm:flex cursor-pointer select-none sm:items-center sm:ml-6">
                        ...
                        <a v-if="local == 'ar'" class="flex justify-between items-center mx-2" href="/lang/en">
                        ...
                        <a v-else class="flex justify-between items-center mx-2" href="/lang/ar">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <g fill="#fff" stroke="#c09300" transform="matrix(.8 0 0 .8 -40 0)">
                                    <path stroke-linejoin="round" stroke-width="1.3"
                                    ...
                                    <path id="a" fill="#c09300" stroke="none"
                                    ...
                                    <use width="100%" height="100%" transform="matrix(-1 0 0 1 900 0)"
                                        xlink:href="#a" />
                                    <path fill="#c09300" stroke-width="1.1"
                                    ...
                                    <g id="b" fill="none" stroke-linejoin="round" stroke-width="1.3">
                                        <path fill="#fff" stroke-width="1.2"
                                    ...
                                    <g stroke-width="1.3">
                                        ...
                                        <path fill="#c09300" stroke-width=".3"
            ...
            <div :class="{
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <a v-if="local == 'ar'" class="flex justify-start items-center px-4 py-2 my-4 hover:bg-gray-100" href="/lang/en">
                        <div class="mr-2">EN</div>
                        <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us" viewBox="0 0 640 480" width="24"
                            height="24">
                            <g fill-rule="evenodd">
                                <g stroke-width="1pt">
                                    <path fill="#bd3d44"
                    ...
                    <a v-else class="flex justify-start items-center px-4 py-2 my-4 hover:bg-gray-100" href="/lang/ar">
                        <div class="mr-2">AR</div>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            id="flag-icon-css-eg" viewBox="0 0 640 480" height="24" width="24">
                            <path d="M0 320h640v160H0z" />
