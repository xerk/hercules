        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('clients')" :active="$page.currentRouteName == 'clients'">
                                Data Area
                            </jet-nav-link>
                            ...
                            <jet-nav-link href="#" class="cursor-not-allowed">
                                Facebook
                                <span
                                    class="text-xs bg-red-500 rounded-full mx-2 text-white px-2 shadow-md py-1">Soon</span>
                            </jet-nav-link>
                            <jet-nav-link href="#" class="cursor-not-allowed">
                                SEO
                                <span
                    ...
                    <!-- Settings Dropdown -->
                    <div class="hidden sm:flex cursor-pointer select-none sm:items-center sm:ml-6">
                        <div
                            ...
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    <button v-if="
                                        ...
                                        <img class="h-8 w-8 rounded-full object-cover shadow-md"
                                ...
                                <template #content>
                                    ...
                                    <template v-if="$page.jetstream.hasTeamFeatures">
                                        ...
                                        <jet-dropdown-link :href="route('teams.create')" v-if="
                                                ...
                                                <jet-dropdown-link as="button">
                                                    <div class="flex items-center">
                                                        <svg v-if="
																...
																$page.user
																	.current_team_id
															" class="mr-2 h-5 w-5 text-green-400" fill="none" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div :class="{
                ...
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <jet-responsive-nav-link :href="route('clients')" :active="$page.currentRouteName == 'clients'">
                        Data Area
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link :href="route('purchase')" :active="$page.currentRouteName == 'purchase'">
                        Purchase Points
                    </jet-responsive-nav-link>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="bg-indigo-500 shadow-md px-2 py-2 rounded-full font-bold text-white flex items-center justify-center mb-4 mx-4">
                        <span class="mr-1">{{$page.user.point}}</span>
                        <span class="text-xs">Points +</span>
                    </div>
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('api-tokens.index')" :active="
                        ...
                        <template v-if="$page.jetstream.hasTeamFeatures">
                            ...
                            <jet-responsive-nav-link :href="route('teams.create')" :active="
