                        ...
                        <div>
                            <div class="bg-white shadow rounded-lg">
                                ...
                                <div class="p-6 flex flex-wrap items-end">
                                    ...
                                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 pb-2 px-2">
                                        <div class="flex mt-4 items-center">
                                            <input id="exist-username" v-model="form.existUsername" type="checkbox"
                                                class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded mr-2" />
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                <tr class="text-gray-700 dark:text-gray-400" v-for="(result, key) in results"
                                    :key="key">
                                    <td class="px-4 py-3">
                                        {{ key }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-sm capitalize">
                                        <a class="hover:underline text-indigo-500" :href="route(
                                                    'clients.fb.download',
                                                    key
                                                )">{{ __("Download") }}</a>
                                        <a class="hover:underline ml-2 text-indigo-500"
                                            :href="route('facebook.data', key)">{{ __("Show") }}</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
