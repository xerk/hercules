                ...
                <div class="flex flex-wrap">
                    <div class="relative w-full sm:w-1/2 md:w-1/3 lg:w-1/3 px-2">
                        ...
                        <div class="bg-white shadow rounded-lg">
                            ...
                            <div class="p-2">
                                <ul class="px-4 overflow-scroll max-h-96 my-2" v-if="
                                        clients.length > 0 && !form.processing
                                    ">
                                    <li class="pb-2 flex justify-between items-center" v-for="(client, key) in clients"
                                        :key="key">
                                ...
                                <div class="font-semibold my-4 text-center" v-if="form.processing">
                                    Loading data...
                                </div>
                            </div>
                        </div>
                    ...
                    <form @submit.prevent="searchResult" class="w-full sm:w-1/2 md:w-2/3 lg:w-2/3 px-2">
                        ...
                        <div>
                            <div class="bg-white shadow rounded-lg">
                                ...
                                <div class="p-6 flex flex-wrap items-end">
                                    <!-- Religion -->
                                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 pb-2 px-2">
                                        <jet-label for="religion" :value="__('Religion')" />
                                        <vue-tags-input v-model="form.religion" :tags="form.religions" @tags-changed="
                                                newTags =>
                                    ...
                                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 pb-2 px-2">
                                        ...
                                        <div class="flex items-center">
                                            <div class="w-full mr-2">
                                                <select v-model="form.birthdateFrom"
                                                    class="form-input rounded-md shadow-sm mt-1 block w-full"
                                                    id="birthdateFrom">
                                                    <option value="all">All</option>
                                                    <option :value="data" v-for="(data,
                                                        key) in 80" :key="key">
                                                        {{ data }}</option>
                                                </select>
                                            ...
                                            <div class="w-full ml-2">
                                                <select :disabled="
                                                    ...
                                                    id="birthdateTo">
                                                    <option value="all">All</option>
                                                    <option :value="birthdateTo" v-for="(birthdateTo,
                                                        key) in 80" :key="key">
                                                        {{
                                                            birthdateTo
                                                        }}</option>
                                    ...
                                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 pb-2 px-2">
                                        ...
                                        <select v-model="form.relationship"
                                            ...
                                            <option value="all">All</option>
                                            <option :value="relationship.value" v-for="(relationship,
                                                key) in relationships" :key="key">
                                        ...
                                        <vue-tags-input v-model="form.work" :tags="form.works"
                                            ...
                                            <div slot="autocomplete-item" slot-scope="props" @click="props.performAdd(props.item)">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <div class="font-semibold text-gray-700 px-1">
                                                        ({{ props.item.count }})
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="w-full sm:w-full pb-2 px-2">
                                        ...
                                        <vue-tags-input v-model="form.position" :tags="form.positions"
                                            @tags-changed="positionUpdate" :allow-edit-tags="true" :autocomplete-items="
                                                autocompleteItems
                                            " :add-only-from-autocomplete="true" placeholder="Add Position">
                                    ...
                                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 pb-2 px-2">
                                        ...
                                        <vue-tags-input v-model="form.hometown" :tags="form.hometowns"
                                            @tags-changed="hometownUpdate" :autocomplete-items="
                                                autocompleteItems
                                            " :add-only-from-autocomplete="true" :allow-edit-tags="true" placeholder="Add Hometown">
                                            <div slot="autocomplete-item" slot-scope="props" @click="
                                                    props.performAdd(props.item)
                                                ">
                                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 pb-2 px-2">
                                        ...
                                        <vue-tags-input v-model="form.location" :tags="form.locations"
                                            @tags-changed="locationUpdate" :autocomplete-items="
                                                autocompleteItems
                                            " :add-only-from-autocomplete="true" :allow-edit-tags="true" placeholder="Add location">
                                            <div slot="autocomplete-item" slot-scope="props" @click="
                                                    props.performAdd(props.item)
                                                ">
                                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="w-full sm:w-full pb-2 px-2">
                                        ...
                                        <vue-tags-input v-model="form.education" :tags="form.educations"
                                            @tags-changed="educationUpdate" :autocomplete-items="
                                                autocompleteItems
                                            " :add-only-from-autocomplete="true" :allow-edit-tags="true" placeholder="Add Education" >
                                            <div slot="autocomplete-item" slot-scope="props" @click="
                                                    props.performAdd(props.item)
                                                ">
                                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 pb-2 px-2">
                                        <div class="flex mt-4 items-center">
                                            <input id="exist-email" v-model="form.existEmail" type="checkbox"
                                                :value="false"
                                        ...
                                        <jet-input-error :message="form.error('existEmail')" class="mt-2" />
                                    </div>
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                <tr class="text-gray-700 dark:text-gray-400" v-for="(result, key) in results.data"
                                    :key="key">
                                    <td class="px-4 py-3">
                                        {{ result.order }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-sm capitalize">
                                        <a class="hover:underline text-indigo-500" :href="
                                            ...
                                            ">{{ __("Download") }}</a>
                                        <a class="hover:underline ml-2 text-indigo-500" :href="
                                                route(
                                                    'facebook.data',
                                                    result.group
                                                )
